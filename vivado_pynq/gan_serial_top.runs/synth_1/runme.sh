...
HD_PWD='D:/GANMIND/GANMIND/vivado_pynq/gan_serial_top.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gan_serial_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gan_serial_top.tcl

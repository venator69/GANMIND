...
HD_PWD='D:/GANMIND/GANMIND/vivado_pynq/gan_serial_top.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gan_serial_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gan_serial_top.tcl -notrace

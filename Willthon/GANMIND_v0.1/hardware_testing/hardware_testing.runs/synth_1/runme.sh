...
HD_PWD='D:/GANMIND/GANMIND/Willthon/GAN_test/hardware_testing/hardware_testing.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log layer1_generator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source layer1_generator.tcl

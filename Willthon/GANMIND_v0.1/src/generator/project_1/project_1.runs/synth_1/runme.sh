...
HD_PWD='D:/GANMIND/GANMIND/Willthon/GANMIND_v0.1/src/generator/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log generator_pipeline.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source generator_pipeline.tcl

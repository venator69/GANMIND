...
set genomeRtd $env(RT_TMP)/193455E3260.rtd
set parallel_map_command "rt::do_reinfer_area_combined 0"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {layer3_generator}]"
...
set genomeName [subst -nocommands -novariables {layer3_generator}]

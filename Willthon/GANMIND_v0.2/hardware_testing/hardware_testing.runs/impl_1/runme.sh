...
HD_PWD='D:/GANMIND/GANMIND/Willthon/GAN_test/hardware_testing/hardware_testing.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log layer1_generator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source layer1_generator.tcl -notrace

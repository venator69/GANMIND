...
set genomeRtd $env(RT_TMP)/19322F52C90.rtd
set parallel_map_command "rt::do_reinfer_area_combined 0"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {layer1_generator__GB3}]"
...
set genomeName [subst -nocommands -novariables {layer1_generator__GB3}]

...
HD_PWD='D:/GANMIND/GANMIND/Willthon/GANMIND_v0.1/src/generator/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log generator_pipeline.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source generator_pipeline.tcl -notrace

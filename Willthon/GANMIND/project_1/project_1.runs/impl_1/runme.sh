...
HD_PWD='D:/GANMIND/GANMIND/Willthon/GAN_test/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log layer1_discriminator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source layer1_discriminator.tcl -notrace

...
HD_PWD='D:/GANMIND/GANMIND/Willthon/GAN_test/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log layer1_discriminator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source layer1_discriminator.tcl

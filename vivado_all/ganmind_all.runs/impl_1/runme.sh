...
HD_PWD='D:/GANMIND/GANMIND/vivado_all/ganmind_all.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gan_serial_axi_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gan_serial_axi_wrapper.tcl -notrace

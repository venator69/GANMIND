...
HD_PWD='D:/GANMIND/GANMIND/vivado_all/ganmind_all.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gan_serial_axi_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gan_serial_axi_wrapper.tcl
